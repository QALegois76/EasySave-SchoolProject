...
{
    public class SetRepDestJobCommandUI : ICommand
    {
        ...
        public SetRepDestJobCommandUI(IJobMng model, IModelViewJob modelView)
        {
            _model = model;
        ...
        public void Execute(object parameter)
        {
            ...
            if (parameter.ToString() == _modelView.HELP)
            {
                ...
                _model.Jobs[_model.EditingJobName].DestinationFolder = parameter.ToString();
        }
    }
